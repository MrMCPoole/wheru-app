...
self.addEventListener('install', (event) => {
  ...
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .catch((error) => {
        console.error('WherU: Failed to cache resources:', error);
      })
  );
});
...
self.addEventListener('push', (event) => {
  ...
  const options = {
    ...
    icon: 'data:image/svg+xml,%3Csvg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 192 192"%3E%3Crect width="192" height="192" fill="%234facfe"/%3E%3Cpath d="M96 40c-30.928 0-56 25.072-56 56 0 42 56 96 56 96s56-54 56-96c0-30.928-25.072-56-56-56zm0 76c-11.046 0-20-8.954-20-20s8.954-20 20-20 20 8.954 20 20-8.954 20-20 20z" fill="white"/%3E%3C/svg%3E',
    badge: 'data:image/svg+xml,%3Csvg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 192 192"%3E%3Crect width="192" height="192" fill="%234facfe"/%3E%3Cpath d="M96 40c-30.928 0-56 25.072-56 56 0 42 56 96 56 96s56-54 56-96c0-30.928-25.072-56-56-56zm0 76c-11.046 0-20-8.954-20-20s8.954-20 20-20 20 8.954 20 20-8.954 20-20 20z" fill="white"/%3E%3C/svg%3E',
    vibrate: [200, 100, 200],
    data: {
